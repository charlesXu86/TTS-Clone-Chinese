...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--out_dir", type=Path, default="/Data/xiaobensuan/Codes/TTS-Clone-Chinese-master/dataset/SV2TTS/synthesizer", help= \
    ...
    parser.add_argument("-d", "--dataset", type=str, default="thchs30", help= \
